...
namespace hs 
{
	...
	namespace factory
	{
		...
		entity *create_particle_emitter(std::string filename, double duration, vec3d position, bool autostart = false);
		entity *create_particle_emitter(particle_emitter *existing_em, double duration, vec3d position, bool autostart = false);
